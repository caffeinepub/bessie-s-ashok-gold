    ...
    <main className="min-h-screen bg-background">
      ...
      <section className="relative bg-secondary border-b border-gold/20 py-16 text-center">
        <div className="container mx-auto px-4 md:px-6">
          <p className="font-display text-xs tracking-widest uppercase text-gold mb-3">Get In Touch</p>
          <h1 className="font-display text-4xl md:text-5xl font-bold text-foreground mb-4">
            Contact Us
          </h1>
          <p className="text-muted-foreground font-body text-lg max-w-xl mx-auto">
            We'd love to hear from you. Reach out via WhatsApp or email and we'll get back to you as soon as possible.
          </p>
        </div>
      </section>
      ...
      <section className="container mx-auto px-4 md:px-6 py-16">
        <div className="max-w-3xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          >
            ...
            <div>
              <h2 className="font-display text-xl font-bold text-foreground mb-1">WhatsApp Us</h2>
          ...
          >
            ...
            <div>
              <h2 className="font-display text-xl font-bold text-foreground mb-1">Email Us</h2>
              <p className="text-sm text-muted-foreground font-body mb-3">
        ...
        <div className="max-w-3xl mx-auto mt-12 p-8 rounded-2xl border border-gold/20 bg-secondary text-center">
          ...
          <h3 className="font-display text-lg font-bold text-foreground mb-2">Bessie's Ashok Gold</h3>
          <p className="text-muted-foreground font-body text-sm leading-relaxed">
            We are available Monday – Saturday, 10:00 AM – 7:00 PM IST.<br />
