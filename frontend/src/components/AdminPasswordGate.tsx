    ...
    return (
      <main className="min-h-screen flex items-center justify-center px-4 bg-background">
        <div className="w-full max-w-sm">
          ...
          {/* Form */}
          <form onSubmit={handleSubmit} className="card-dark rounded-xl p-6 space-y-5">
            <div className="space-y-2">
              <Label htmlFor="admin-password" className="text-xs font-body text-muted-foreground tracking-widest uppercase">
                Password
              </Label>
              <div className="relative">
                <Input
